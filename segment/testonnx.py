...
parser.add_argument('-name', type=str, default='Test Onnx Inference', help='Test Name.')
parser.add_argument('-description', type=str, default='Onnx image segmentation inference test', help='Test Description.')
