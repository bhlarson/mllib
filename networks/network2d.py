...
def parse_arguments():
    ...
    parser.add_argument('-model_src', type=str,  default='segment_nas_512x442_20220215_03')
    parser.add_argument('-model_dest', type=str, default='segment_nas_512x442_20220215_04')
