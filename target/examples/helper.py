...
class ModelOptimizer():
    ...
    def convert(self, output_saved_model_dir, precision="FP32", max_workspace_size_bytes=8000000000, **kwargs):
        ...
        conversion_params = trt.DEFAULT_TRT_CONVERSION_PARAMS._replace(precision_mode=trt_precision, 
                                                                       max_workspace_size_bytes=max_workspace_size_bytes,
                                                                       use_calibration= precision == "INT8")
        converter = trt.TrtGraphConverterV2(input_saved_model_dir=self.input_saved_model_dir,
